  ...
  <section>
    ...
    <div class="profile-box box-left">
      ...
      <?php
        ...
        $query = "SELECT * FROM customer WHERE username = '".$_SESSION['username']."' AND password = '".$_SESSION['password']."'";
        ...
        if($result = mysqli_query($con, $query)) {
          ...
          $query_date = "SELECT DATE_FORMAT(date_joined, '%m/%d/%Y') FROM customer WHERE id = '".$_SESSION['userid']."'";
