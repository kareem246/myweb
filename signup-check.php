...
if (isset($_POST['uname']) && isset($_POST['password'])
    && isset($_POST['name']) && isset($_POST['re_password'])  && isset($_POST['age']) && isset($_POST['phone']) && isset($_POST['address']) && isset($_POST['gender']) ) {
	...
	if (empty($uname)) {
		...
		if (mysqli_num_rows($result) > 0) {
           ...
           $sql2 = "INSERT INTO users(user_name, password, name , age , phone , address , gender) VALUES('$uname', '$pass', '$name' , '$age' , '$phone' , '$address' , '$gender')";
